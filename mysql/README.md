...
## Different vs stable/mysql

stable/mysql is deployment. k8s-mysql use the statefulset and can be deploy multi cluster with replicas.

## Introduction

This chart bootstraps a single node MySQL statefulset on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
